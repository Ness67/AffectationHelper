...
<head>
    ...
    <title>Choix des postes - Voir</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-6">
				<?php
					$stmt = $bdd->prepare('SELECT nom, prenom FROM users WHERE id = :usid;');
					$stmt->bindValue(':usid', $_GET['usid'], PDO::PARAM_INT);
					$stmt->execute();
					$rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
					?>
                        <div class="panel-heading">
                            <?php echo "<p>Postes de " .$rows[0]['nom'] . " " . $rows[0]['prenom'] . "</p>"; ?>
                        </div>
                        <!-- /.panel-heading -->
						...
						<div class="table-responsive">
							<?php
								...
								$stmt->bindValue(':user', $_GET['usid'], PDO::PARAM_INT);
								$stmt->execute();
								$rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
								 ?>
                                <table class="table">
